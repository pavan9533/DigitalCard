...
//	    }
	...
	public void validateElementPresent(String locatorKey, String elementName) {
	    try {
	        ...
	        //reportFailure(errorMessage, false);
	...
	public void validateFieldRequiredErrors(String NameErrorLocator, String DomainErrorLocator, String StartDateErrorLocator, 
		...
		String DuplicateDomainError = "'https://test.com' domain already exist, Please enter another domain.";

		Assert.assertEquals(NameError.getText(), error,NameError.getText()+" is displayed for name input." );
		if(DomainError.getText().toLowerCase().equals(DuplicateDomainError)){
		Assert.assertEquals(DomainError.getText(), DuplicateDomainError,DomainError.getText()+" is displayed for Duplicate Domain input." );
		}else {
			Assert.assertEquals(DomainError.getText(), error,DomainError.getText()+" is displayed for Duplicate Domain input." );
		}
		Assert.assertEquals(StartDateError.getText(), error,StartDateError.getText()+" is displayed for Start Date input." );
		Assert.assertEquals(ToDateError.getText(), error,ToDateError.getText()+" is displayed for To Date input." );
		Assert.assertEquals(NoOfCardsError.getText(), error,NoOfCardsError.getText()+" is displayed for No.Of Cards input." );
